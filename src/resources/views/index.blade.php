        ...
        <table class="index-table" cellpadding="10">
            <tr class="table-line">
                ...
                <td class="table-cell">
                    <div class="name-separate">
                        <div class="name-wrap">
                            <input class="name-input-area input-box" type="text" name="last_name" placeholder="例）山田" value="{{ old('last_name') }}">
                            <div class="error-message">
                                @error('last_name'){{ $message }}@enderror
                            </div>
                        </div>
                        <div class="name-wrap">
                            <input class="name-input-area input-box" type="text" name="first_name" placeholder="例）太郎" value="{{ old('first_name') }}">
                            <div class="error-message">
            ...
            <tr class="table-line">
                ...
                <td id="email" class="table-cell">
                    <input class="input-area input-box" type="email" name="email" placeholder="test@example.com" value="{{old('email')}}">
                    <div class="error-message">
            ...
            <tr class="table-line">
                ...
                <td class="table-cell">
                    <div class="tel-align">
                        <div class="tel-wrap">
                            <input class="tel-input input-box" name="front-tel"
                        ...
                        <div class="tel-wrap">
                            <input class="tel-input input-box" name="middle-tel"
                        ...
                        <span class="tel-separator">-</span>
                        <div class="tel-wrap">
                            <input class="tel-input input-box" name="back-tel"
            ...
            <tr class="table-line">
                ...
                <td id="address" class="table-cell">
                    <input class="input-area address-input input-box" type="text" name="address" placeholder="例）東京都渋谷区千駄ヶ谷1-2-3" value="{{old('address')}}">
                    <div class="error-message">
            ...
            <tr class="table-line">
                ...
                <td class="table-cell">
                    <input class="input-area input-box" type="text" name="building" placeholder="例）千駄ヶ谷マンション101" value="{{ old('building') }}">
                </td>
            </tr>
            <tr class="table-line">
            ...
            <tr class="table-line">
                <th class="column-name">お問い合わせ内容<span class="attention">※</span></th>
                <td class="table-cell">
